...
| 1 | `step1_protocols/` | Protocol playground | OIDC login flow live, SAML vs OIDC, SCIM |
| 2 | `step2_platforms/` | Platform test matrix | Web vs desktop vs mobile identity QA |
| 3 | `step3_ai_generation/` | AI-generated tests → validated → executed on real tenant | Agentic quality engineering |
| 4 | `step4_cicd/` | GitHub Actions quality gate | Shift-left, CI secrets, test environments |
