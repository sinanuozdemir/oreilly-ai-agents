...
- **information-retrieval** — Adding explicit domain knowledge about the app's functionality will allow the agent to better answer user questions about its purpose.
