...
This file is maintained automatically by **Agent Etna** for **streamlit**.
...
## Agent
- **Repo:** `sinanuozdemir/oreilly-ai-agents` (branch `main`)
...
- **safety:dialog-scope** — The agent needs a clearer instruction to refuse disguised attempts at extracting sensitive information to strengthen its dialog safety scope.
